...
var _RibbonView2 = _interopRequireDefault(_RibbonView);
...
var Entities = {
    User: _vendor.Backbone.Model.extend({
        defaults: {
            loggedIn: false
        }
    }),
    UserLogin: _vendor.Backbone.Model.extend({
        defaults: {
            username: null,
            password: null,
            loggedIn: false,
...
exports.default = _vendor.Marionette.View.extend({
    ...
    onRender: function onRender() {
        this.showChildView("ribbonRegion", new _RibbonView2.default({ model: new Entities.UserLogin() }));
    },
    ...
    logout: function logout(username) {
...
var _ribbon = require('../templates/ribbon.tpl');
...
with(obj||{}){
__p+='<div class="js-ribbon-region"></div> <div class="js-content-region"></div> <div class="js-modal-region"></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="house-interaction-container"> <button class="js-find-house-button btn">Find</button> <button class="js-register-house-button btn">Register</button> </div> <div class="account-interaction-container"> <button class="js-login-button btn"> ';
 if (loggedIn) { 
__p+=' Logout ';
 } else { 
__p+=' Login ';
...
exports.App = exports.Marionette = exports.Backbone = exports.$ = exports._ = undefined;
...
var App = _backbone6.default.channel('App');
